...
class ClassFile:
    ...
    @staticmethod
    def remove_by_content_size(source, min_size=100, encoding='ISO-8859-1'):
        """
        filter all files with size greater than 0
        """
        file_filter = list()
                ...
                try:
                    if os.path.isfile(file) and os.path.getsize(file) > 0:
                        ...
                        try:
                            ...
                            ocr_text_decoded = data_decoded.decode(encoding, errors='replace')
    ...
    @staticmethod
    def filter_by_content_size(source, size=0):
        """
        filter all files with size greater than 0
        """
        file_filter = list()
    ...
    @staticmethod
    def to_txtfile_by_line(data: list, file_, mode="w", encoding="ISO-8859-1"):
        """
    ...
    @staticmethod
    def get_text(filename, encoding="utf-8"):
        """
    ...
    @staticmethod
    def divide_chunks(collection: list, n):
