...
class Configuration:
    ...
    def __init__(self, conf_route="tc_config.yml", working='text_class'):
        ...
        try:
            with open(os.path.join(self.root_path, 'common', conf_route), 'r') as yml_file:
        ...
        # reference
        bert = cfg['bert']
        self.bert_model_path = bert['path']
        self.bert_ner_name = bert['name']
        self.bert_tokenizer_path = bert['tokenizer']
